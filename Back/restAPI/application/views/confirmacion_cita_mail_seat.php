						...
						bgcolor="#fff">
							<tbody>
								...
								<tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
									...
									align="center" bgcolor="#71b6f9" valign="top"><a href="#" style="font-size:32px;color:#fff; pointer-events: none;">Cita confirmada</a>
									<br>
									<span style="margin-top: 10px;display: block; color: #fff">Tu cita se agend&oacute; con &eacute;xito</span>
									<br>
										...
										<tbody>
											...
											<tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
												<td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top"> 
													...
													<br>
													<img style="max-width: 185px; max-height: 40%; float: right;" src="https://gruposanangel.com/fotosPersonal/<?php echo $foto; ?>">
													</td>
											</tr>
										</tbody>
									</table></td>
