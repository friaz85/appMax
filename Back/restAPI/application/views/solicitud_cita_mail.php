						...
						bgcolor="#fff">
							<tbody>
								...
								<tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
									...
									<br>
									<span style="margin-top: 10px;display: block; color: #fff">Gracias por agendar tu cita de servicio en VW San &Aacute;ngel, en un momento m&aacute;s confirmaremos v&iacute;a telef&oacute;nica o por WhatsApp.
</span></td>
								</tr>
